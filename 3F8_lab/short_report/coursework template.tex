...
\begin{figure}
\begin{centering}
\includegraphics[width=0.3\paperwidth]{fig2.png}\hspace{1cm}\includegraphics[width=0.3\paperwidth]{fig3.png}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.32\textwidth]{fig6.png}\hspace{0.15cm}\includegraphics[width=0.32\textwidth]{fig7.png}\hspace{0.15cm}\includegraphics[width=0.32\textwidth]{fig8.png}
\par\end{centering}
